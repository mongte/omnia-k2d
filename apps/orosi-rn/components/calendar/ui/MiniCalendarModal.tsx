...
export function MiniCalendarModal({ visible, onClose, onDateSelect, initialDate }: MiniCalendarModalProps) {
  ...
  // Data for Selectors
  const yearData = React.useMemo(() => Array.from({ length: TOTAL_YEARS }, (_, i) => BASE_YEAR + i), []);
  const monthData = React.useMemo(() => Array.from({ length: TOTAL_MONTHS }, (_, i) => {
              ...
              <View style={styles.header}>
                   <View style={styles.selectorsResult}>
                      ...
                      <GradientSelector
                          ...
                          onIndexChanged={(index) => {
                              ...
                              if (year !== focusedDay.getFullYear()) {
                                  setFocusedDay(new Date(year, focusedDay.getMonth(), focusedDay.getDate()));
                              }
                          }}
                          renderItem={(item) => (
                      ...
                      <GradientSelector
                          ...
                          renderItem={(item) => (
                              <Text style={styles.monthText}>{format(item, 'MMM').toUpperCase()}</Text>
                          )}
                      />
                   </View>
              </View>
